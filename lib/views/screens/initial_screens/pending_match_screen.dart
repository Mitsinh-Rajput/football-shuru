...
class _PendingMatchScreenState extends State<PendingMatchScreen>
  ...
  static const List<Tab> myTabs = <Tab>[
    Tab(text: 'Ground Matches'),
    Tab(text: 'League Matches'),
  ];
                    ...
                    builder: (kingChallengeController) {
                      return ListView.separated(
                          ...
                          itemBuilder: (context, index) {
                            final matchData = kingChallengeController
                                .pendingMatchResultList[index];

                            return GestureDetector(
                              onTap: () {
                                if (matchData.winningTeamConfirmation ==
                                    "confirmed") {
                                  Navigator.push(
                                      context,
                                      getCustomRoute(
                          ...
                          itemCount: kingChallengeController
                              .pendingMatchResultList.length);
                    },
                  ),
                ),
                RefreshIndicator(
