...
class TournamentChatScreen extends StatefulWidget {
  const TournamentChatScreen({super.key});
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Row(
          children: [
            Text(
              "414304, Ambika nagar, Thane",
              style: Theme.of(context).textTheme.titleLarge!.copyWith(fontSize: 16, fontWeight: FontWeight.w600, color: Colors.white),
            ),
                                ...
                                RichText(
                                  text: TextSpan(
                                      ...
                                      children: [
                                        TextSpan(
                                          text: " Challenge Now",
                                          style: Theme.of(context).textTheme.titleSmall!.copyWith(fontSize: 10, fontWeight: FontWeight.w600, color: Color(0xFFFF9100)),
                                        )
                                      ]),
                                ),
                              ],
            ...
            Column(
              children: [
                ...
                SizedBox(
                  ...
                  child: TabBarView(
                    controller: _tabController,
                    children: <Widget>[GroundChatroom(), GameSlot(), TournamentStatsSection()],
                  ),
                ),
              ],
            )
