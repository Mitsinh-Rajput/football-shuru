...
class TournamentChatScreen extends StatefulWidget {
  const TournamentChatScreen({Key? key}) : super(key: key);
...
class _TournamentChatScreenState extends State<TournamentChatScreen> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    // log(isScroll.toString(), name: "IS_SCroll");
            ...
            child: Column(
              children: [
                ...
                Expanded(
                  child: TabBarView(
                    controller: _tabController,
                    children: <Widget>[const GroundChatroom(), const GameSlot(), const TournamentStatsSection()],
                  ),
                ),
              ],
            ),
