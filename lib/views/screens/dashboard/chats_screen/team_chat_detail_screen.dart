...
class TeamChatDetailScreen extends StatefulWidget {
  final JoinedTeam team;
  const TeamChatDetailScreen({super.key, required this.team});

  @override
  State<TeamChatDetailScreen> createState() => _TeamChatDetailScreenState();
}

class _TeamChatDetailScreenState extends State<TeamChatDetailScreen> {
  ...
  void dispose() {
    ...
    super.dispose();
    Get.find<ChatController>().teamChat.clear();
  }
        ...
        title: Column(
          ...
          children: [
            ...
            Container(
              decoration: BoxDecoration(color: Colors.white, borderRadius: BorderRadius.circular(10)),
              child: Text(
                "${widget.team.team?.usersCount ?? ""} • members".toUpperCase(),
                style: Theme.of(context).textTheme.labelMedium!.copyWith(
            ...
            children: [
              Expanded(
                child: ListView.builder(
                    ...
                    itemCount: chatController.teamChat.length,
                    itemBuilder: (context, index) {
                      final chat = chatController.teamChat[index];
                      final previousMessage = index < (chatController.teamChat.length - 1) ? chatController.teamChat[index + 1] : null;
